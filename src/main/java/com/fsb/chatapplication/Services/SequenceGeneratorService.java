...
//        String sql = "SELECT seq FROM chats_database_sequences WHERE id = ?";
//        Integer seq = jdbcTemplate.queryForObject(sql, Integer.class, seqName);
//        if (seq == null) {
//            seq = 1;
//            String insertSql = "INSERT INTO chats_database_sequences (id, seq) VALUES (?, ?)";
//            jdbcTemplate.update(insertSql, seqName, seq);
//        } else {
//            String updateSql = "UPDATE chats_database_sequences SET seq = seq + 1 WHERE id = ?";
